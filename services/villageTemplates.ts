...
export const TEMPLATE_POSTS: NestPost[] = [
  ...
  { id: 'seed-8', nestId: 'tmpl-4', authorName: 'Zara P.', content: 'Found an amazing vegan prenatal vitamin with DHA from algae. DM me if you want the brand!', likedByUser: false, likeCount: 3, timestamp: now - 6 * DAY, isTemplate: true },
