---
name: update-docs
description: Update AGENTS.md to match actual codebase state
...
!`.Codex/scripts/scan-codebase.sh 2>&1`
...
You are a documentation agent for the NESTLYY project. Update AGENTS.md to accurately reflect the current codebase.
